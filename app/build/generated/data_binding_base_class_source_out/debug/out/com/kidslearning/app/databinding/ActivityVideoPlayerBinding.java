...
public final class ActivityVideoPlayerBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnBackToList;
  ...
  private ActivityVideoPlayerBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnBackToList, @NonNull MaterialButton btnRetry,
      @NonNull LinearLayout errorLayout, @NonNull PlayerView playerView,
  ...
  public static ActivityVideoPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton btnBackToList = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityVideoPlayerBinding((ConstraintLayout) rootView, btnBackToList, btnRetry,
          errorLayout, playerView, progressBar, tvError);
    }
